<script lang="ts">
    ...
    const packageManagers = [
        { id: "npm", label: "npm", command: "npm install @macroforge/core" },
        { id: "pnpm", label: "pnpm", command: "pnpm add @macroforge/core" },
        { id: "yarn", label: "yarn", command: "yarn add @macroforge/core" },
        { id: "bun", label: "bun", command: "bun add @macroforge/core" },
        { id: "deno", label: "deno", command: "deno add npm:@macroforge/core" },
    ];
