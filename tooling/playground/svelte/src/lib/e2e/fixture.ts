...
/**
 * Raw JSON fixture for intersection type testing.
 * SavingsAccount = { variant: "savings"; interestRate: number } & AccountBase
 */
export const savingsAccountFixture = {
  variant: "savings",
  interestRate: 0.045,
  id: "acc_001",
...
/**
 * Raw JSON fixture for intersection type testing.
 * CheckingAccount = { variant: "checking"; overdraftLimit: number } & AccountBase
 */
export const checkingAccountFixture = {
  variant: "checking",
  overdraftLimit: 500,
  id: "acc_002",
  name: "Bob's Checking",
