...
import { CallHierarchyProviderImpl } from '../../../../src/plugins/typescript/features/CallHierarchyProvider.ts';
            ...
            <CallHierarchyIncomingCall[]> [
                {
                    ...
                    // the `formatDate(...)` call inside `formatDate2`
                    fromRanges: [
                        rangeOf(getFullPath('util.ts'), 'formatDate', {
                            after: 'formatDate2'
                        })
                    ]
                },
