...
export function __serializeTaxRate(value: TaxRate, ctx: SerializeContext): Record<string, unknown> {
...
export function __deserializeTaxRate(value: any, ctx: DeserializeContext): TaxRate | PendingRef {
...
export function hasShapeTaxRate(obj: unknown): boolean {
...
export function isTaxRate(obj: unknown): obj is TaxRate {
    if (!hasShapeTaxRate(obj)) {
        return false;
    }
    const result = fromObjectTaxRate(obj);
    return Result.isOk(result);
}

/** Nested error structure matching the data shape */ export type ErrorsTaxRate = {
...
export interface FieldControllersTaxRate {
...
export interface GigaformTaxRate {
    readonly data: TaxRate;
    readonly errors: ErrorsTaxRate;
    readonly tainted: TaintedTaxRate;
    readonly fields: FieldControllersTaxRate;
...
export function createFormTaxRate(overrides?: Partial<TaxRate>): GigaformTaxRate {
    ...
    let tainted = $state<TaintedTaxRate>({
        id: Option.none(),
        name: Option.none(),
        taxAgency: Option.none(),
        zip: Option.none(),
    ...
    const fields: FieldControllersTaxRate = {
        id: {
            path: ['id'] as const,
            name: 'id',
...
export function fromFormDataTaxRate(
    formData: FormData
): Result<TaxRate, Array<{ field: string; message: string }>> {
