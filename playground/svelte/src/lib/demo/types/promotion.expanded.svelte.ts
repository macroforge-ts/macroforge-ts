...
export function __deserializePromotion(
    ...
    if (typeof value !== 'object' || value === null || Array.isArray(value)) {
        throw new DeserializeError([
            { field: '_root', message: 'Promotion.__deserialize: expected an object' }
        ]);
    }
...
export function hasShapePromotion(obj: unknown): boolean {
...
export function isPromotion(obj: unknown): obj is Promotion {
    if (!hasShapePromotion(obj)) {
        return false;
    }
    const result = fromObjectPromotion(obj);
    return Result.isOk(result);
}

/** Nested error structure matching the data shape */ export type ErrorsPromotion = {
    _errors: Option<Array<string>>;
    id: Option<Array<string>>;
    date: Option<Array<string>>;
}; /** Nested boolean structure for tracking touched/dirty fields */
export type TaintedPromotion = {
    id: Option<boolean>;
    date: Option<boolean>;
}; /** Type-safe field controllers for this form */
export interface FieldControllersPromotion {
    readonly id: FieldController<string>;
    readonly date: FieldController<string>;
} /** Gigaform instance containing reactive state and field controllers */
export interface GigaformPromotion {
    readonly data: Promotion;
    readonly errors: ErrorsPromotion;
    readonly tainted: TaintedPromotion;
    readonly fields: FieldControllersPromotion;
...
export function createFormPromotion(overrides?: Partial<Promotion>): GigaformPromotion {
    ...
    let tainted = $state<TaintedPromotion>({ id: Option.none(), date: Option.none() });
    const fields: FieldControllersPromotion = {
        id: {
            path: ['id'] as const,
            name: 'id',
