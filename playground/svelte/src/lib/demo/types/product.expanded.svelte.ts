...
export function __serializeProduct(value: Product, ctx: SerializeContext): Record<string, unknown> {
...
export function __deserializeProduct(value: any, ctx: DeserializeContext): Product | PendingRef {
...
export function hasShapeProduct(obj: unknown): boolean {
...
export function isProduct(obj: unknown): obj is Product {
    if (!hasShapeProduct(obj)) {
        return false;
    }
    const result = fromObjectProduct(obj);
    return Result.isOk(result);
}

/** Nested error structure matching the data shape */ export type ErrorsProduct = {
...
export interface FieldControllersProduct {
...
export interface GigaformProduct {
    readonly data: Product;
    readonly errors: ErrorsProduct;
    readonly tainted: TaintedProduct;
    readonly fields: FieldControllersProduct;
...
export function createFormProduct(overrides?: Partial<Product>): GigaformProduct {
    ...
    let tainted = $state<TaintedProduct>({
        id: Option.none(),
        name: Option.none(),
        quickCode: Option.none(),
        group: Option.none(),
    ...
    const fields: FieldControllersProduct = {
        id: {
            path: ['id'] as const,
            name: 'id',
