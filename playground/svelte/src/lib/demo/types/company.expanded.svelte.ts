...
export function __serializeCompany(value: Company, ctx: SerializeContext): Record<string, unknown> {
...
export function __deserializeCompany(value: any, ctx: DeserializeContext): Company | PendingRef {
...
export function hasShapeCompany(obj: unknown): boolean {
...
export function isCompany(obj: unknown): obj is Company {
    if (!hasShapeCompany(obj)) {
        return false;
    }
    const result = fromObjectCompany(obj);
    return Result.isOk(result);
}

/** Nested error structure matching the data shape */ export type ErrorsCompany = {
...
export interface FieldControllersCompany {
...
export interface GigaformCompany {
    readonly data: Company;
    readonly errors: ErrorsCompany;
    readonly tainted: TaintedCompany;
    readonly fields: FieldControllersCompany;
...
export function createFormCompany(overrides?: Partial<Company>): GigaformCompany {
    ...
    let tainted = $state<TaintedCompany>({
        id: Option.none(),
        legalName: Option.none(),
        headquarters: Option.none(),
        phones: Option.none(),
    ...
    const fields: FieldControllersCompany = {
        id: {
            path: ['id'] as const,
            name: 'id',
...
export function fromFormDataCompany(
    formData: FormData
): Result<Company, Array<{ field: string; message: string }>> {
