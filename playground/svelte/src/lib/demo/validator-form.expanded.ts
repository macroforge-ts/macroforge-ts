...
export class UserRegistrationForm {
    ...
    static validateField<K extends keyof UserRegistrationForm>(field: K, value: UserRegistrationForm[K]): Array<{
    field: string;
    message: string;
}> {
    const errors: Array<{
...
export class ProductForm {
    ...
    static validateField<K extends keyof ProductForm>(field: K, value: ProductForm[K]): Array<{
    field: string;
    message: string;
}> {
    const errors: Array<{
...
export class EventForm {
    ...
    static validateField<K extends keyof EventForm>(field: K, value: EventForm[K]): Array<{
    field: string;
    message: string;
}> {
    const errors: Array<{
