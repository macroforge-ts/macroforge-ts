...
export class ValidDateValidator {
  ...
  static fromStringifiedJSON(json: string, opts?: DeserializeOptions): Result<ValidDateValidator, string[]> {
    try {
  ...
  static __deserialize(value: any, ctx: DeserializeContext): ValidDateValidator | PendingRef {
    ...
    const errors: string[] = [];
    if (!("date" in obj)) {
        errors.push("ValidDateValidator.__deserialize: missing required field \"date\"");
    }
    if (errors.length > 0) {
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"];
        {
            ...
            if (__dateVal == null || isNaN(__dateVal.getTime())) {
                errors.push("ValidDateValidator.fromStringifiedJSON: field 'date' must be a valid date");
            }
...
export class GreaterThanDateValidator {
  ...
  static fromStringifiedJSON(json: string, opts?: DeserializeOptions): Result<GreaterThanDateValidator, string[]> {
    try {
        const ctx = DeserializeContext.create();
        const raw = JSON.parse(json);
  ...
  static __deserialize(value: any, ctx: DeserializeContext): GreaterThanDateValidator | PendingRef {
    ...
    if (typeof value !== "object" || value === null || Array.isArray(value)) {
        throw new Error("GreaterThanDateValidator.__deserialize: expected an object");
    }
    const obj = value as Record<string, unknown>;
    const errors: string[] = [];
    if (!("date" in obj)) {
        errors.push("GreaterThanDateValidator.__deserialize: missing required field \"date\"");
    }
    if (errors.length > 0) {
        throw new Error(errors.join("; "));
    }
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"];
        {
            ...
            if (__dateVal == null || __dateVal.getTime() <= new Date("2020-01-01").getTime()) {
                errors.push("GreaterThanDateValidator.fromStringifiedJSON: field 'date' must be after 2020-01-01");
            }
            (instance as any).date = __dateVal;
        }
    }
...
export class GreaterThanOrEqualToDateValidator {
  ...
  static fromStringifiedJSON(json: string, opts?: DeserializeOptions): Result<GreaterThanOrEqualToDateValidator, string[]> {
    try {
        const ctx = DeserializeContext.create();
        const raw = JSON.parse(json);
        const resultOrRef = GreaterThanOrEqualToDateValidator.__deserialize(raw, ctx);
        if (PendingRef.is(resultOrRef)) {
            return Result.err([
  ...
  static __deserialize(value: any, ctx: DeserializeContext): GreaterThanOrEqualToDateValidator | PendingRef {
    ...
    if (typeof value !== "object" || value === null || Array.isArray(value)) {
        throw new Error("GreaterThanOrEqualToDateValidator.__deserialize: expected an object");
    }
    const obj = value as Record<string, unknown>;
    const errors: string[] = [];
    if (!("date" in obj)) {
        errors.push("GreaterThanOrEqualToDateValidator.__deserialize: missing required field \"date\"");
    }
    if (errors.length > 0) {
        throw new Error(errors.join("; "));
    }
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"];
        {
            const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
            if (__dateVal == null || __dateVal.getTime() < new Date("2020-01-01").getTime()) {
                errors.push("GreaterThanOrEqualToDateValidator.fromStringifiedJSON: field 'date' must be on or after 2020-01-01");
            }
            (instance as any).date = __dateVal;
        }
    }
...
export class LessThanDateValidator {
  ...
  static fromStringifiedJSON(json: string, opts?: DeserializeOptions): Result<LessThanDateValidator, string[]> {
    try {
        const ctx = DeserializeContext.create();
        const raw = JSON.parse(json);
  ...
  static __deserialize(value: any, ctx: DeserializeContext): LessThanDateValidator | PendingRef {
    ...
    if (typeof value !== "object" || value === null || Array.isArray(value)) {
        throw new Error("LessThanDateValidator.__deserialize: expected an object");
    }
    const obj = value as Record<string, unknown>;
    const errors: string[] = [];
    if (!("date" in obj)) {
        errors.push("LessThanDateValidator.__deserialize: missing required field \"date\"");
    }
    if (errors.length > 0) {
        throw new Error(errors.join("; "));
    }
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"];
        {
            ...
            if (__dateVal == null || __dateVal.getTime() >= new Date("2030-01-01").getTime()) {
                errors.push("LessThanDateValidator.fromStringifiedJSON: field 'date' must be before 2030-01-01");
            }
            (instance as any).date = __dateVal;
        }
    }
...
export class LessThanOrEqualToDateValidator {
  ...
  static fromStringifiedJSON(json: string, opts?: DeserializeOptions): Result<LessThanOrEqualToDateValidator, string[]> {
    try {
        const ctx = DeserializeContext.create();
        const raw = JSON.parse(json);
        const resultOrRef = LessThanOrEqualToDateValidator.__deserialize(raw, ctx);
        if (PendingRef.is(resultOrRef)) {
            return Result.err([
  ...
  static __deserialize(value: any, ctx: DeserializeContext): LessThanOrEqualToDateValidator | PendingRef {
    ...
    if (typeof value !== "object" || value === null || Array.isArray(value)) {
        throw new Error("LessThanOrEqualToDateValidator.__deserialize: expected an object");
    }
    const obj = value as Record<string, unknown>;
    const errors: string[] = [];
    if (!("date" in obj)) {
        errors.push("LessThanOrEqualToDateValidator.__deserialize: missing required field \"date\"");
    }
    if (errors.length > 0) {
        throw new Error(errors.join("; "));
    }
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"];
        {
            const __dateVal = typeof __raw_date === "string" ? new Date(__raw_date) : __raw_date as Date;
            if (__dateVal == null || __dateVal.getTime() > new Date("2030-01-01").getTime()) {
                errors.push("LessThanOrEqualToDateValidator.fromStringifiedJSON: field 'date' must be on or before 2030-01-01");
            }
            (instance as any).date = __dateVal;
        }
    }
...
export class BetweenDateValidator {
  ...
  static fromStringifiedJSON(json: string, opts?: DeserializeOptions): Result<BetweenDateValidator, string[]> {
    try {
        const ctx = DeserializeContext.create();
        const raw = JSON.parse(json);
  ...
  static __deserialize(value: any, ctx: DeserializeContext): BetweenDateValidator | PendingRef {
    ...
    const errors: string[] = [];
    if (!("date" in obj)) {
        errors.push("BetweenDateValidator.__deserialize: missing required field \"date\"");
    }
    if (errors.length > 0) {
        throw new Error(errors.join("; "));
    }
    ...
    ctx.trackForFreeze(instance);
    {
        const __raw_date = obj["date"];
        {
            ...
            if (__dateVal == null || __dateVal.getTime() < new Date("2020-01-01").getTime() || __dateVal.getTime() > new Date("2030-01-01").getTime()) {
                errors.push("BetweenDateValidator.fromStringifiedJSON: field 'date' must be between 2020-01-01 and 2030-01-01");
            }
            (instance as any).date = __dateVal;
        }
    }
