...
const vm = require('vm');
const { expandSync } = require('~/macroforge-ts/crates/macroforge_ts/index.js');

const filePath = '~/macroforge-ts/playground/vanilla/src/validators/string-validator-tests.ts';
