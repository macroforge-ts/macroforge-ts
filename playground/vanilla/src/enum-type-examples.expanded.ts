...
export namespace Status {export function toJson(value: Status): string {return JSON.stringify(value);}export function __serialize(_ctx: SerializeContext): string | number {return value;}}

export namespace Status {export function fromJson(json: string): Status {const data = JSON.parse(json); return __deserialize(data);}export function __deserialize(data: unknown): Status {for(const key of Object.keys(Status)){const enumValue = Status[key as keyof typeof Status]; if(enumValue === data){return data as Status;}}throw new Error("Invalid Status value: " + JSON.stringify(data));}}
...
export namespace Priority {export function toJson(value: Priority): string {return JSON.stringify(value);}export function __serialize(_ctx: SerializeContext): string | number {return value;}}

export namespace Priority {export function fromJson(json: string): Priority {const data = JSON.parse(json); return __deserialize(data);}export function __deserialize(data: unknown): Priority {for(const key of Object.keys(Priority)){const enumValue = Priority[key as keyof typeof Priority]; if(enumValue === data){return data as Priority;}}throw new Error("Invalid Priority value: " + JSON.stringify(data));}}
